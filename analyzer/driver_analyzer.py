...
def train_analyzer(train_text, test_text, train_labels, test_labels, sentences):
  ...
  df_predicciones = pd.DataFrame(predicciones, columns=['CalificacionChoferes'])

  df_predicciones.loc[df_predicciones.CalificacionChoferes == 0, 'CalificacionChoferes'] = 'Negativo'
  df_predicciones.loc[df_predicciones.CalificacionChoferes == 1, 'CalificacionChoferes'] = 'Neutral'
  df_predicciones.loc[df_predicciones.CalificacionChoferes == 2, 'CalificacionChoferes'] =  'Positivo'
